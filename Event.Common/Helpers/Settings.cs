namespace Event.Common.Helpers
{
    ...
    public static class Settings
    {
        ...
        private const string votings = "votings";
        ...
        {
            get => AppSettings.GetValueOrDefault(votings, stringDefault);
            set => AppSettings.AddOrUpdateValue(votings, value);
        }
